									...
									<!-- Start XP Col -->
									 <div class="col-md-12 col-lg-12 col-xl-12">
											 <div class="text-center mt-3 mb-5">
													 <h4>APPROVISIONNEMENT DU STOCK INTER-DEPOT</h4>
											 </div>
									 </div>
									 <!-- End XP Col -->
                    <div class="col-md-12 col-lg-12 col-xl-12">
                            ...
                            <div class="card-body">
																	<div class="form-group">
																		<label for="depotsource">Dépôt Source</label>
																		<input type="text" class="form-control" value="<?=session('lieuAffectation')->nom ?>" disabled>
																	</div>
                                  <div class="form-group">
                                    <label for="depots_id">Dépôt Destination</label>
																		<select class="form-control" v-model="depots_id">
																			<option v-for="(dp, i) in depotList" :value="dp.id" v-if="dp.id != dpot_id">{{dp.nom}}</option>
																		</select>
                                	...
                                	<button v-if="!isLoadSaveMainButton" @click="add_approvision_inter_depot" class="btn btn-primary">Enregistrer</button>
                                ...
                                <div class="row">
	                                ...
	                                <div class="form-group col-md-4 col-lg-4 col-xl-4">
	                                  <input type="text" class="form-control" id="exampleInputPassword1" v-model="qte">
																	...
																	<div class="form-group col-md-4 col-lg-4 col-xl-4">
	                                   <button v-if="!isLoadSaveMainButtonModal" class="btn btn-round btn-success" @click="_u_create_line_article_appro_inter_depot"><i class="mdi mdi-plus"></i> </button>
