                                ...
                                <h5 class="card-title text-black">INFORMATIONS SUR LES ACHATS {{stateStatus==1?'EN ATTENTE':(stateStatus==2?'PAYE(S)':(stateStatus==3?'LIVRE(S)':'ANNULE(S)'))}} {{dateFilterDisplay}}</h5>
                                      ...
                                      Annulée <span class="badge badge-pill badge-light">{{ListFiltreData.annuler==undefined?'0':ListFiltreData.annuler}}</span>
																	...
																	<div class="pull-right row">
																		...
																		<button class="btn btn-round btn-info margin-left-4" @click="_u_formatDateFilter(get_commande_magazinier)"><i class="mdi mdi-search-web"></i> </button>
																	</div>
																</div>
														...
														<div class="container">
															...
															<div v-for="(det,i) in detailTab.logic_article" class="">
																<div class="row">
																	...
																	<span v-if="parseFloat(det.logic_qte_stock_article_depot)<parseFloat(det.qte_vendue)" class="col-md-2 text-warning text-right"><i class="mdi mdi-alert-circle cursor"></i>
																	</span>
																</div>
																<br>
																<div class="row">
																	...
																	<span class="col-md-3" v-if="stateStatus==2">Stock <br><span :class="parseFloat(det.logic_qte_stock_article_depot)>=parseFloat(det.qte_vendue)?'text-success':'text-danger'">{{det.logic_qte_stock_article_depot}}</span></span>
