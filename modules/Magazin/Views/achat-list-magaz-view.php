															...
															<div class="" v-if="detailTab.status_vente_id.id ==3">
																...
																<div class="col-md-12">
																	<div class="text-center">
																		<button v-if="!isLoadSaveMainButtonModal" @click="_u_open_mod_popup_retour_payer(detailTab)" class="btn btn-danger">REMETRE EN PAYER</button>
...
<!-- REMETRE FACTURE LIVRER EN PAYER  -->
<div class="modal fade show u-animation-FromTop" tabindex="-1" role="dialog" aria-hidden="true" :style="{display: styleModalShow}">
	<div class="modal-dialog" role="document">
			<div class="modal-content">
					...
					<div class="modal-body">
						<div v-if="!isNoQuantity" class="text-center">
							<span>Vous êtes sur le point de remetre une facture déjà livrée en status payé,</span>
							...
							<button v-if="!isLoadSaveMainButtonModal" @click="change_facture_livrer_en_payer()" class="btn btn-primary">Confirmer</button>
							<!-- <button v-if="!isLoadSaveMainButtonModal && isPartielle" @click="add_validation_livraison_partielle()" class="btn btn-primary">Confirmer</button> -->
							<img v-if="isLoadSaveMainButtonModal" src="<?=base_url() ?>/public/load/loader.gif" alt="">
						</div>
