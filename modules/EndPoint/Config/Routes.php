...
$routes->group('api/v1', function($routes){
  ...
  $routes->get('articles-search-data-appro-inte-depot/(:any)/(:num)/(:num)/(:num)/search','Articles::article_search_for_appro_inter_depot/$1/$2/$3/$4');
  ...
  $routes->get('get-decaissement-externe-par-caissier/(:num)/(:num)/(:any)/(:any)/(:num)','OperationCaisseEncaissement::getDecaissementExterne/$1/$2/$3/$4/$5');
