...
use App\Entities\TendersEntity;
use App\Models\ImageSecondairesModel;

class Tenders extends ResourceController {
  protected $modelName = '\App\Models\TendersModel';
  ...
  public function tenders_create(){
    ...
    $dataFiles = $this->request->getFileMultiple('input-file-other');
      if($insertData = $this->model->insert(new TendersEntity($data))){
