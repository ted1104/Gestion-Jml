									...
									<!-- Start XP Col -->
									 <div class="col-md-12 col-lg-12 col-xl-12">
											 <div class="text-center mt-3 mb-5">
													 <h4>LISTE DES ENCAISSEMENTS EXTERNE</h4>
											 </div>
									 </div>
									 <!-- End XP Col -->
                    <div class="col-md-12 col-lg-12 col-xl-12">
                            ...
                            <div class="card-header bg-white">
                                <h5 class="card-title text-black">Informations relatives aux encaissements Externe</h5>
                            </div>
                            <div class="card-body">
                                  <div class="form-group">
                                    <label for="montant_encaissement">Montant *</label>
                                    <input type="text" class="form-control" v-model="montant_encaissement">
                                  </div>
																	<div class="form-group">
                                    <label for="motif">Motif Source *</label>
                                    <textarea class="form-control" name="inputTextarea" id="motif" rows="3" v-model="motif"></textarea>
                                  </div>
                              		<button v-if="!isLoadSaveMainButton" @click="add_encaissement_externe" class="btn btn-primary">Enregistrer</button>
