									...
									<!-- Start XP Col -->
									 <div class="col-md-12 col-lg-12 col-xl-12">
											 <div class="text-center mt-3 mb-5">
													 <h4>LISTE DE TOUS LES ARTICLE CONFIG</h4>
											 </div>
									 </div>
									 <!-- End XP Col -->
                    <div class="col-md-12 col-lg-12 col-xl-12">
													...
													<div class="card m-b-30 u-animation-FromRight" v-if="isShow">
														<div class="container padding-4">
															...
															<!-- <div  class="row"> -->
																...
																<hr>
																<div class="row text-center">
																	<h5 class="col-md-12 card-title">VISIBILITE SUR LISTE ARTICLE</h5>
																</div>
																<div class="text-center">
																	<button v-if="!isLoadSaveMainButtonModal" @click="active_article_visibilite_sur_liste(detailTab.id)" :class="detailTab.is_visible==1?'btn btn-danger':'btn btn-success'">{{detailTab.is_visible==1?'Désactiver':'Activer'}}</button>
																	<img v-if="isLoadSaveMainButtonModal" src="<?=base_url() ?>/public/load/loader.gif" alt="">
																</div>
