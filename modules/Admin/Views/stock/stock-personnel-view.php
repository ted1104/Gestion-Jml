									...
									<!-- Start XP Col -->
									 <div class="col-md-12 col-lg-12 col-xl-12">
											 <div class="text-center mt-3 mb-5">
													 <h4>STOCK PERSONNEL MAGAZINIER</h4>
											 </div>
									 </div>
									 <!-- End XP Col -->
                    <div class="col-md-12 col-lg-12 col-xl-12">
                            ...
                            <div class="card-header bg-white">
															<div class="row">
																<h5 class="card-title text-black col-md-4">STOCK PERSONNEL EN DEPOT</h5>
																<!-- <div class="col-md-8">
																...
																<div class="row">
																	<div class="table-responsive container">
																		<table class="table">
																			...
																			<tbody>
																				<tr v-for="(det,i) in detailTab.stock_personnel">
																					<td>{{det.code_article}}</td>
																					<td>{{det.nom_article}}</td>
																					<td>{{det.qte_stock}}</td>
																					<?php if(session('users')['info'][0]->roles_id == 1):  ?>
																					<td>
																						<span @click="_u_open_mod_popup_edit_qte_stock_personnel(detailTab, det)" class="btn btn-round btn-light cursor"><i class="mdi mdi-circle-edit-outline"></i></span>
																					</td>
																					<?php endif ?>
