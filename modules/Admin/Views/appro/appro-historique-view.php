									...
									<!-- Start XP Col -->
									 <div class="col-md-12 col-lg-12 col-xl-12">
											 <div class="text-center mt-3 mb-5">
													 <h4>HISTORIQUE APPROVISIONNEMENT</h4>
											 </div>
									 </div>
									 <!-- End XP Col -->
                    <div class="col-md-12 col-lg-12 col-xl-12">
	                                		...
	                                		<h5 class="card-title text-black">INFORMATIONS SUR LES APPROVISONNEMENT EFFECTUES</h5>
																	...
																	<div class="col-md-5">
																		<div class="pull-right row">
																			...
																			<button class="btn btn-round btn-outline-secondary margin-left-4" @click="_u_formatDateFilterWithoutStatus(get_historique_approvisionnement)"><i class="mdi mdi-search-web"></i> </button>
																		</div>
																	</div>
                                </div>
