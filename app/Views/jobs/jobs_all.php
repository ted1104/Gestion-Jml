...
<?=$this->section('content') ?>
  <main class="main-page u-animation-FromBottom">
    ...
    <section class="tenders">
      ...
      <a v-for="(tender, index) in DataProperties" :href="'<?=isLoggedIn() ? base_url('admin-jobs-detail.dy'):base_url('jobs-detail') ?>/'+ tender.id" class="card ted-col ted-col-mob-2-c1-c3 ted-col-tab-por-2-c1-c3 ted-col-tab-land-2-c1-c6 ted-col-e-7 u-margin-bottom-6x">
				...
				<form class="ted-col ted-col-e-1 form u-margin-top-5x" autocomplete="off">
					<?=csrf_field()?>
						<div class="ted-col u-animation-CommingHiddenToVisibleOpacity" v-show="showFormHouseData">
							<h3>Tender Logo and file to upload</h3>
							<div class="ted-col ted-col-tab-land-2-c1-c2">
								<div class="form__group form__group-upload">
									<span class="u-margin-bottom-2x">Choose jOb company Logo Image</span>
						...
						<div class="ted-col u-animation-CommingHiddenToVisibleOpacity" v-show="!showFormHouseData">
							...
							<div class="ted-col ted-col-mob-1 ted-col-tab-por-1 u-margin-top-2x">
								...
								<div>
									<button name="button" class="btn btn-secondary btn-size-tab-land-3" @click="create_jobs">Save</button>
								</div>
								</div>
							</div>
					</div>
