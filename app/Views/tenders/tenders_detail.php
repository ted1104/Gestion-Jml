      ...
      <div class="ted-col ted-col-tab-land-2 note-section u-margin-top-5x">
        <div class="">
          <p class="u-content-vertical u-font-size-mob u-font-size-tab-por">
            <span><span class="u-bold">Note :</span> Click on the APPLY button to send your application documents <a v-if= "DataProperties[0].linkapply !=''" :href="DataProperties[0].linkapply" target="_blank" class="u-color-red">( Apply link )</a> </span>
