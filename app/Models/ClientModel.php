...
class ClientModel extends Model{
  ...
  protected $validationRules = [
    ...
    'telephone_client' => 'required|is_unique[g_interne_client.telephone_client]',
    'addresse' => 'required',
  ];
  protected $validationMessages = [
    'nom_client'=>['required' => 'Le nom du client est obligatoire',],
    'prenom_client'=>['required' => 'Le prénom du client est obligatoire'],
    'telephone_client'=>['required' => 'Le téléphone du client est obligatoire','is_unique'=>'Un autre client avec ce même numéro de téléphone existe déjà'],
