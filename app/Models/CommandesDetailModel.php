...
class CommandesDetailModel extends Model{
  ...
  protected $allowedFields = ['vente_id','articles_id','qte_vendue','prix_unitaire','type_prix','is_negotiate','prix_negociation','is_faveur','is_livrer','is_validate_livrer','prix_transport','livrer_by'];
