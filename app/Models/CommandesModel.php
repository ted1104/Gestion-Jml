...
class CommandesModel extends Model{
  ...
  protected $allowedFields = ['numero_commande','nom_client','telephone_client','date_vente','status_vente_id','users_id','depots_id','payer_a','is_negotiate','is_transported','container_faveur','depots_id_faveur','depots_id_first_livrer','is_livrer_all','retour_en_payer'];
